...
(function() {
  ...
  ComponentGroup = (function() {
    ...
    ComponentGroup.prototype.update = function(opts) {
      var ignoreCurrentAlpha, ignoreY, item, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _results, _results1;
      ...
      switch (opts.type) {
        ...
        case 'fadeIn':
          ...
          for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
            ...
            lib[item].alpha = 0;
            if (!opts.target) {
              ignoreY = (_ref5 = opts.ignoreY) != null ? _ref5 : false;
              ignoreCurrentAlpha = (_ref6 = opts.ignoreCurrentAlpha) != null ? _ref6 : false;
              lib[item].fadeIn(ignoreY, ignoreCurrentAlpha);
            }
          }
          if (opts.target) {
            ignoreY = (_ref7 = opts.ignoreY) != null ? _ref7 : false;
            ignoreCurrentAlpha = (_ref8 = opts.ignoreCurrentAlpha) != null ? _ref8 : false;
        ...
        case 'fadeOut':
          ...
          for (_n = 0, _len5 = _ref9.length; _n < _len5; _n++) {
            ...
            TweenLite.killTweensOf(lib[item]);
            if (!opts.target) {
              ignoreY = (_ref10 = opts.ignoreY) != null ? _ref10 : false;
              ignoreCurrentAlpha = (_ref11 = opts.ignoreCurrentAlpha) != null ? _ref11 : false;
              lib[item].fadeOut(ignoreY, ignoreCurrentAlpha);
            }
          }
          if (opts.target) {
            ignoreY = (_ref12 = opts.ignoreY) != null ? _ref12 : false;
            ignoreCurrentAlpha = (_ref13 = opts.ignoreCurrentAlpha) != null ? _ref13 : false;
  ...
  TextContainer = (function(_super) {
    ...
    TextContainer.prototype.initialize = function(opts) {
      var align, fcolor, font, t, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
  ...
  SpriteContainer = (function(_super) {
    ...
    SpriteContainer.prototype.initialize = function(opts) {
      var align, _ref, _ref1, _ref2, _ref3;
      this.Container_initialize();
      Module.extend(this, d2oda.methods);
      Module.extend(this, d2oda.actions);
      align = (_ref = opts.align) != null ? _ref : '';
  ...
  ButtonContainer = (function(_super) {
    ...
    ButtonContainer.prototype.initialize = function(opts) {
      ...
      this.index = opts.index;
      this.name = (_ref = opts.name) != null ? _ref : opts.id;
      this.scale = (_ref1 = opts.scale) != null ? _ref1 : 1;
      this.states = opts.states;
      this.currentState = 0;
      this.overTween = (_ref2 = opts.overTween) != null ? _ref2 : true;
      this.setImageText(this.states[this.currentState].img, this.states[this.currentState].txt);
      this.alpha = (_ref3 = opts.alpha) != null ? _ref3 : 1;
      if (this.isArray(opts.target)) {
        this.target = opts.target;
      } else {
        this.target = lib[opts.target];
    ...
    ButtonContainer.prototype.setImageText = function(img, txt) {
      var align, b, hit, t, text, x, y, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if (txt) {
        ...
        this.txtFont = (_ref4 = txt.font) != null ? _ref4 : this.txtFont;
        this.txtColor = (_ref5 = txt.color) != null ? _ref5 : this.txtColor;
        x = (_ref6 = txt.x) != null ? _ref6 : 0;
        y = (_ref7 = txt.y) != null ? _ref7 : 0;
        this.txtAlign = (_ref8 = txt.align) != null ? _ref8 : this.txtAlign;
  ...
  ChooseContainer = (function(_super) {
    ...
    ChooseContainer.prototype.update = function(opts) {
      var bmp, hito1, hito2, hito3, lineWidth, opt1, opt2, opt3, y, _ref, _ref1;
      this.removeAllChildren();
      console.log(opts);
      switch (opts.type) {
        case 'img':
  ...
  PhraseCompleterContainer = (function(_super) {
    ...
    PhraseCompleterContainer.prototype.update = function(opts) {
      var align, h, h2, i, maxWidth, npos, t, txt, ypos, _i, _len, _ref, _ref1, _ref2;
      this.removeAllChildren();
      this.label = (_ref = opts.label) != null ? _ref : '';
      if (opts.h2) {
        align = (_ref1 = opts.h2.align) != null ? _ref1 : '';
  ...
  PhraseCloneContainer = (function(_super) {
    ...
    PhraseCloneContainer.prototype.update = function(opts) {
      var align, h, h2, i, npos, t, txt, _i, _len, _ref, _ref1;
      this.removeAllChildren();
      if (opts.h2) {
  ...
  WordSearchContainer = (function(_super) {
    ...
    WordSearchContainer.prototype.isComplete = function() {
      var complete, word, _i, _len, _ref;
      complete = true;
      _ref = this.words;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        word = _ref[_i];
  ...
  ScrambledWordContainer = (function(_super) {
    ...
    ScrambledWordContainer.prototype.initialize = function(opts) {
      ...
      this.align = (_ref7 = opts.align) != null ? _ref7 : '';
      this.margin = (_ref8 = opts.margin) != null ? _ref8 : 5;
      this.oncomplete = (_ref9 = opts.oncomplete) != null ? _ref9 : null;
      this["eval"] = opts["eval"];
      this.currentTarget = 0;
      this.observer = new ComponentObserver();
      return this.droptargets = new Array();
          ...
          for (_i = 0, _len = step.length; _i < _len; _i++) {
            ...
            switch (target.name) {
              case 'total':
                ...
                _results.push(d2oda.evaluator.total_index = 0);
                break;
              case 'global':
